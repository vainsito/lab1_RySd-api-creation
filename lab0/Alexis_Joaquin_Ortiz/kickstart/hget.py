...
def connect_to_server(server_name):
    ...
    # Crear socket
    s = socket.socket(socket.AF_INET, socket.SOCK_STREAM) #la segunda macro hace referencia a la transferencia de datos TCP (Conexion orientada a la conexion, hay comunicacion y intercambio de datos)
    # COMPLETAR ABAJO DE ESTA LINEA
